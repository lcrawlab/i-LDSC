...
class __GenotypeArrayInMemory__(object):
    ...
    def ldScoreVarBlocks(self, block_left, c, annot=None, meld=False):
        ...
        if not meld:
            ...
            self._currentSNP = 0
            snp_getter = self.nextSNPs
            return self.__corSumVarBlocksMeld__(block_left, c, func, snp_getter, annot)
    ...
    def __corSumVarBlocksMeld__(self, block_left, c, func, snp_getter, annot=None):
        '''
        Parameters
        ----------
